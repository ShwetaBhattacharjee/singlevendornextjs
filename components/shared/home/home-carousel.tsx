...
export function HomeCarousel({ items }: { items: ICarousel[] }) {
  ...
  return (
    <>
      <Head>
        {/* Add default metadata for the homepage */}
        <meta
          name="description"
          content="Explore a vast selection of high-quality car parts, accessories, and upgrades"
        />
        <meta property="og:image" content="/icons/logo.png" />
        <meta
          property="og:description"
          content="Explore a vast selection of high-quality car parts, accessories, and upgrades for every make and model."
        />
